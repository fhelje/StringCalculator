describe("String calculator", function () {
    var stringShouldHaveSum = function (numbers, result) {
    ...
    var stringShouldThrow = function (numbers, exception) {
        it('when string is "' + numbers.replace("\n", "\\n") + '" exception should be thrown', function () {
            var calulator = new Kata.StringCalculator();
            expect(function () {
                return calulator.calculate(numbers);
            }).toThrow(exception);
        });
    };
    ...
    describe("Numbers bigger than 1000 should be ignored", function () {
        stringShouldHaveSum("1001", 0);
        stringShouldHaveSum("1,1001", 1);
    });
});
